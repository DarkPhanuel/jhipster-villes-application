package fr.esgi.villes.web.rest;

import static fr.esgi.villes.domain.JoueurAsserts.*;
import static fr.esgi.villes.web.rest.TestUtil.createUpdateProxyForBean;
...
import fr.esgi.villes.IntegrationTest;
import fr.esgi.villes.domain.Joueur;
import fr.esgi.villes.repository.JoueurRepository;
...
class JoueurResourceIT {
    ...
    void partialUpdateJoueurWithPatch() throws Exception {
        ...
        partialUpdatedJoueur.pseudo(UPDATED_PSEUDO).motDePasse(UPDATED_MOT_DE_PASSE).estAdministrateur(UPDATED_EST_ADMINISTRATEUR);
